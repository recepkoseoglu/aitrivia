...
1.3. Uygulamayı kullanarak bu politikayı kabul etmiş sayılırsınız.
...
Uygulama anonim giriş kullandığı için kişisel kimlik bilgisi toplanmaz.

### 2.3. Satın Alma Verileri

Premium satın alma işlemleri Apple App Store veya Google Play üzerinden gerçekleşir. Ödeme bilgileriniz doğrudan bu platformlarda işlenir; biz ödeme kartı veya banka bilgisi almıyoruz.
...
- Oyun ve skor verileri: Hizmet süresince
- Anonim UID: Hesap silinene kadar
- Satın alma kayıtları: Yasal saklama süreleri boyunca

### 4.2. Güvenlik Önlemleri

- Veriler Firebase (Google) altyapısında şifreli olarak saklanır
- HTTPS üzerinden iletişim
- Erişim yetkilendirmesi ve güvenlik kuralları
...
5.1. Veri ihlali durumunda yasal süreler içinde ilgili kişilere ve yetkili kurumlara bildirim yapılacaktır.
...
8.1. Bu politika güncellenebilir. Önemli değişiklikler Uygulama veya web sitesi üzerinden duyurulacaktır.

8.2. Güncel metin her zaman bu sayfada yer alacaktır.
